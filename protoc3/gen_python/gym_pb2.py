...
_REQUEST13003_PARAMS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wantGymId', full_name='com.xiang.proto.gym.Request13003.Params.wantGymId', index=3,
